...
**Scoreboard** (auto, updated 2026-06-25 20:32) — best **27.91** (H2); leader target 37.
...
_Queued/held:_ H3 (A3, footage 0.099); H4 (A3, footage 0.099); C4 (A2, footage 0.048); CONS (A2xA3, footage tbd); C1 (A2, footage 0.146)

_Next:_ TODAY, 2 slots left: H3 hp400 then H4 hp500 -> bracket the A3 count peak (H1 250=24.87, H2 300=27.91, accelerating). Both at C2 footage (sw 0.45) so it is a clean count axis. If still climbing at 500 -> tomorrow push count further + build a real pay-presence detector (raise precision so A3->100 at lower A2 cost) + CONS (best footage x best count). If it peaks -> CONS the peak.
