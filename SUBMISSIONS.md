...
**Scoreboard** (auto, updated 2026-06-26 04:54) — best **29.91** (H3); leader target 37.
...
_Queued/held:_ H4 (A3, footage 0.099); H5 (A3, footage 0.099); H6 (A3, footage 0.099); C4 (A2, footage 0.048); CONS (A2xA3, footage tbd); C1 (A2, footage 0.146)

_Next:_ NEXT WINDOW = 5 subs / 2h, best H3=29.91, count curve decelerating -> peak ~500-600. ORDER: (1) H4 hp500 [fill the missing point - never scored] (2) H5 hp600 [bracket]. Peak now known -> (3) CONS_<peak>_sw035 = best count x C3 footage (sw 0.35) = the new-high candidate; all 3 prebuilt (hp400/500/600 x sw035). (4) H6 hp700 only to confirm the A2 crater, else skip. (5) flex: push the winning combo further. Branch: H4<H3 -> peak 400 use CONS_H3; H5<H4 -> peak 500 use CONS_H4; both climb -> submit H6 + CONS_H5.
