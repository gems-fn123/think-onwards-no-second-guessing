...
**Scoreboard** (auto, updated 2026-06-24 09:49) — best **22.48** (S2); leader target 37.
...
_Queued/held:_ P1 (A4 (PHIE), footage 0.16); C2 (A2, footage 0.099); C1 (A2, footage 0.146)

_Next:_ Submit P1 (A4-PHIE read) then C2 (A2-floor read); branch the next window off P1's result.
