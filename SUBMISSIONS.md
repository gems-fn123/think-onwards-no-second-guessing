...
**Scoreboard** (auto, updated 2026-06-30 21:15) — best **34.65** (COUNT_KNEE); leader target 37.

| id | score | isolates | ratio⁴ | verdict |
|----|------:|----------|-------:|---------|
| iter1 | 15.03 | â€” | — | scored |
...
| PRECISION_v2_hp400 | 30.09 | A3 | 0.569 | loss |
| PRECISION_v2_hp600 | 33.46 | A3 | 0.870 | loss |
| KEYX_hp450 | 29.47 | A2 | 0.523 | loss |
| PERM_PROBE | 34.18 | A4 | 0.947 | loss |
| PERM_A1hi | 34.65 | A4 | 1.000 | flat |
| REPL_hp750 | 34.30 | A4 | 0.960 | loss |
| REPL_hp135 | 18.32 | A2xA3 | 0.078 | loss |
| SYNTH_hp300 | 27.95 | A3 | 0.423 | loss |
| META_hp650 | 34.44 | A3 | 0.976 | loss |
| META_hp700 | 34.52 | A3 | 0.985 | flat |

_Queued/held:_ C4 (A2, footage 0.048); C1 (A2, footage 0.146); PREC_500_sw025 (A2, footage 0.0109)

_Next:_ SEALED — 34.65 final. Metadata lever exhausted (META 34.44/34.52 < 34.65). Semi-supervised honeypot classifier (38 metadata/structure feats, 135 hard-veto labels) CV AUC=0.55 -> honeypots inseparable, confirmed. Submit COUNT_KNEE_hp750. See AGENT_BRIEF S17.
