...
**Scoreboard** (auto, updated 2026-06-26 04:48) — best **29.91** (H3); leader target 37.
...
_Next:_ TODAY (06-26), 5 slots: H3 hp400 = 29.91 (STILL climbing past H2's 27.91). Submit H4 hp500 (retry), then H5 hp600, H6 hp700 to find the A3 count peak. Likely peak ~500-600: hp700 flags 700/800 so only ~100 wells keep pay -> A2 should crater. Slot 5 = CONS (best count x C3 footage sw 0.35). Tomorrow: a real precision detector to catch all 200 honeypots with FEWER vetoed reals (A3->100 at higher A2) = the ceiling-raiser.
