...
**Scoreboard** (auto, updated 2026-06-25 15:55) — best **23.90** (C2); leader target 37.
...
_Queued/held:_ C3 (A2, footage 0.062); C1 (A2, footage 0.146)

_Next:_ Submit C3 (footage 0.062, sw_max 0.35) vs C2 = 23.9. >24.3 -> push sw 0.30; ~23.9 -> A2 peak is the ceiling (~24); <23.5 -> C2's 0.099 is optimum.
